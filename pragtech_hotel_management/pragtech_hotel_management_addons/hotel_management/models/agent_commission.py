...
class AgentRelation(models.Model):
    ...
    '''def _get_shop_domain(self):
        ...
        company_ids = self.agent_id.user_ids.company_ids.ids
        print("jadejaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa",self.agent_id.user_ids.company_ids.ids)
        # Define the domain to filter the sale shops
        domain = [('agent_id_company.company_ids', 'in', company_ids)]
        print("_get_shop_domain_get_shop_domain_get_shop_domain_get_shop_domain_get_shop_domain",domain)
        return domain'''
