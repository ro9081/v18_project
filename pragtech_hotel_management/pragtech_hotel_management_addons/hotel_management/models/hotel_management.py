...
class hotel_reservation(models.Model):
    ...
    new_currency_id = fields.Many2one('res.currency', string='Currency')
    ...
    def _get_advance_payment(self):
        ...
        for obj in self:
            ...
            print("****************total_advance*********************",obj.total_advance)
            print("****************remaining_amt*********************",obj.remaining_amt)

            sum = 0
            print("****************sum*********************",obj.total_advance)
            print("$$$$$$$$$$$$$$$$$$$$$$$$$Object#$$$$$$$$$$$$$$$$$$$$$",obj.account_move_ids)
            print("$$$$$$$$$$$$$$$$$$$$$$$$$Object#$$$$$$$$$$$$$$$$$$$$$",)
            ...
            for line in obj.account_move_ids:
                ...
                move_lines = self.env['account.move.line'].search(
                    [('move_id', '=', line.id)])
                print("Haiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiii",move_lines)
                if move_lines:
            ...
            print("****************total_advanceweeeeeeeeeeeeeeeeeeeee*********************",obj.total_advance)
    ...
    '''@api.onchange('new_currency_id', 'pricelist_id')
    ...
    '''def update_prices(self):
        ...
        print("HHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHH",lines_to_update)
    ...
    complimentary = fields.Boolean('Complimentary Breakfast',)
    ...
    def create_folio(self):
        #print("crate folioooooooooooooooooooooooooooxxxxxxxxxxxxxxxxxxx")
        for reservation in self:
            room_his_id_search = self.env['hotel.room.booking.history'].search(
                [('booking_id', '=', reservation.id)])
            room_his_id_search.unlink()
            ...
            for line in reservation.reservation_line:
                ...
                #print("ggggggggggggggggggggggggggggggggggggggg",line.checkin)
                ...
                #print("TTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTtt",line.checkin.date(),current_datec)
...
class hotel_folio(models.Model):
    ...
    def action_checkout(self):
        ...
        for room in self.room_lines:
            ...
            #return True
            #else:
                #raise ValidationError("The current date and your check-out date do not match. Please review your reservation details.")
...
class hotel_restaurant_order(models.Model):
    ...
    '''@api.onchange('new_currency_id','currency_id', 'pricelist_id')
    def currency_change(self):
        self.new_currency_id = self.pricelist_id.currency_id.id
        self.currency_id = self.pricelist_id.currency_id.id'''
...
class AdvancePaymentPolicy(models.Model):
    ...
    type = fields.Selection([('direct','Direct Booking'),('website','Website Booking')],string="Booking Type",required=True)
    amount = fields.Float(string="Minimum Amount",required=True)
