...
class BanquetQuotation(models.Model):
    ...
    lead = fields.Many2one('crm.lead', 'Lead', readonly=True)
    contact_name = fields.Many2one('res.partner','Contact Name',required=True, readonly=True)
    ...
    def action_create_tour(self):
        for obj in self:
            ...
            banquet_id = self.env['hotel.reservation'].create({
                ...
                'food_type': True,
                #'food_items_ids': obj.food_items_ids.ids,
            })
